...
| [SQL Server]({{< ref "docs/connectors/pipeline-connectors/sqlserver" >}})         | Source         | <li> SQL Server                                                                                                                                                                                                                                                                                                                                                                                         | [SQL Server](https://mvnrepository.com/artifact/org.apache.flink/flink-cdc-pipeline-connector-sqlserver) |
...
|:-----------------:|:-------------------------:|:-------------------------:|:-------------------------------------------------------------------------------------------:|:----------------------------------------:|
|     **3.6.x**     |      1.20.\*, 2.2.\*      | MySQL, PostgreSQL, Oracle, SQL Server | StarRocks, Doris, Paimon, Kafka, Elasticsearch, OceanBase, MaxCompute, Iceberg, Fluss, Hudi |                                          |
