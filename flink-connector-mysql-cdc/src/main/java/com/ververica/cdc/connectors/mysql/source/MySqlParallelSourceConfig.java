...
public class MySqlParallelSourceConfig implements Serializable {
    ...
    private MySqlParallelSourceConfig(
            String startupMode, String serverIdRange, int splitSize, Properties dbzProperties) {
    ...
    public static final class Builder {
        ...
        /** The properties that {@link DebeziumReader} used. */
        private Properties dbzProperties;

        public Builder() {
            // the default properties that debezium reader used.
            ...
            props.put("database.port", String.valueOf(MySqlSourceOptions.PORT.defaultValue()));
            props.put(
        ...
        public MySqlParallelSourceConfig build() {
            return new MySqlParallelSourceConfig(
                    startupMode, serverIdRange, splitSize, dbzProperties);
        }
    }
