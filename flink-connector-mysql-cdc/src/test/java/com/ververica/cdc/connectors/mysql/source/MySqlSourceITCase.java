...
public class MySqlSourceITCase extends MySqlSourceTestBase {
    ...
    public void testNewlyAddedTableForExistsPipelineOnce() throws Exception {
        testNewlyAddedTableOneByOne(1, FailoverType.NONE, FailoverPhase.NEVER, "address_hangzhou","address_beijing");
    }

    @Test
    public void testNewlyAddedTableForExistsPipelineTwice() throws Exception {
        testNewlyAddedTableOneByOne(4, FailoverType.NONE, FailoverPhase.NEVER, "address_hangzhou","address_beijing", "address_shanghai");
    }
    ...
    public void testJobManagerFailoverForNewlyAddedTable() throws Exception {
        testNewlyAddedTableOneByOne(4, FailoverType.JM, FailoverPhase.SNAPSHOT, "address_hangzhou","address_beijing");
    }

    @Test
    public void testTaskManagerFailoverForNewlyAddedTable() throws Exception {
        testNewlyAddedTableOneByOne(4, FailoverType.TM, FailoverPhase.BINLOG, "address_hangzhou","address_beijing");
    }
    ...
    private void testNewlyAddedTableOneByOne(
        ...
        for (int round = 0; round < captureAddressTables.length; round++) {
            ...
            makeBinlogForAddressTable(getConnection(), newlyAddedTable);
    ...
    private String triggerSavepointWithRetry(JobClient jobClient, String savepointDirectory)
        ...
        int retryTimes = 0;
        // retry 600 times (It takes 100 milliseconds at a time, for a total of 1 minute) at most
    ...
    private void makeBinlogForAddressTable(JdbcConnection connection, String tableName)
            throws SQLException {
        try {
            connection.setAutoCommit(false);
            // make binlog events for the first split
